...
class ClientVueron02(WebSocketWidget):
    ...
    def _initialize(self):
        make_dir(self.app_info.vueron_02_path)
        make_dir(self.app_info.vueron_02_path/'VTK')
    ...
    def _parse_message(self, message):
        ...
        # payload.areaID는 장비가 보고하는 값이라 접속 IP(.152)와 항상 일치한다는 보장이
        # 없음(Pintel의 common[0]과 같은 문제) — 이 소스는 항상 '0002' 고정 접두어로 저장해서
        ...
        saver.push((self.app_info.vueron_02_path, filename, json_data))
